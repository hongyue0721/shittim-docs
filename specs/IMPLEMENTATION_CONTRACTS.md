...
切片1a在61项基线上新增四个component-native root，production manifest现为65项（41 retained + 24 component-native），`method_version_bindings`继续为空；repository/handler/producer不在本切片：
