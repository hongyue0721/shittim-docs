...
- `adr/README.md` — 29 lines
- `docs/DEVELOPMENT_HANDOVER.md` — 155 lines
...
- `docs/api/kernel-sqlite.md` — 214 lines
- `docs/api/schema-generation.md` — 121 lines
- `docs/api/task-repository-contract.md` — 44 lines
- `docs/design/lease-stop-fence-blueprint.md` — 126 lines
...
- `specs/IMPLEMENTATION_CONTRACTS.md` — 2600 lines
