...
- [ADR-0008：Active Event v2 Schema 与版本化统一 Outbox](0008-active-event-v2与版本化统一outbox.md) — accepted；Event v2八Schema/compiler/catalog/generated typed/conformance已实现，migration 0003、mixed Outbox API、producer/Publisher/runtime未完成
