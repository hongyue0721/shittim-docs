...
- [ADR-0006：Child Task 权威与 TaskCreate v2 迁移](0006-child-task权威与taskcreate-v2迁移.md) — accepted；首批Schema、pure-library与official fixtures/harness已实现，repository/handler/materializer/cutover未完成
- [ADR-0007：Approval v2 不可变联合、身份与失效](0007-approval-v2不可变联合身份与失效.md) — accepted；contract-only
- [ADR-0008：Active Event v2 Schema 与版本化统一 Outbox](0008-active-event-v2与版本化统一outbox.md) — accepted；Event v2八Schema/compiler/catalog/generated typed/conformance与migration 0003/mixed Outbox API已实现，active producer/Publisher/runtime未完成
