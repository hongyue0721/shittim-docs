...
- 本 ADR 的后续migration 0002已实现Task create/get repository；migration 0003也已实现descriptor ledger升级与v1/v2统一Outbox。legacy Task producer继续显式走v1 append，active business producer仍待后续repository。
